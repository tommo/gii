enum { 
  ...
  SCI_WRAPCOUNT = 2235, SCI_GETALLLINESVISIBLE = 2236, SCI_SETTABINDENTS = 2260, 
  ...
  SCI_ANNOTATIONGETSTYLEOFFSET = 2551, SCI_SETEMPTYSELECTION = 2556, SCI_GETMARGINOPTIONS = 2557, 
  ...
  SCI_SETADDITIONALCARETSBLINK = 2567, SCI_GETADDITIONALCARETSBLINK = 2568, SCI_SETADDITIONALCARETSVISIBLE = 2608, 
  ...
  SCI_VCHOMEDISPLAYEXTEND = 2653, SCI_STARTRECORD = 3001, SCI_STOPRECORD = 3002, 
  SCI_SETLEXER = 4001, SCI_GETLEXER = 4002, SCI_COLOURISE = 4003, 
  SCI_SETPROPERTY = 4004, SCI_SETKEYWORDS = 4005, SCI_SETLEXERLANGUAGE = 4006, 
  SCI_LOADLEXERLIBRARY = 4007, SCI_GETPROPERTY = 4008, SCI_GETPROPERTYEXPANDED = 4009, 
  SCI_GETPROPERTYINT = 4010, SCI_GETSTYLEBITSNEEDED = 4011, SCI_GETLEXERLANGUAGE = 4012, 
  SCI_PRIVATELEXERCALL = 4013, SCI_PROPERTYNAMES = 4014, SCI_PROPERTYTYPE = 4015, 
  SCI_DESCRIBEPROPERTY = 4016, SCI_DESCRIBEKEYWORDSETS = 4017 
}
...
enum { 
  ...
  INDIC_DOTBOX = 12, INDIC_SQUIGGLEPIXMAP = 13, INDIC_CONTAINER = 8, 
  INDIC_MAX = 31, INDIC0_MASK = 0x20, INDIC1_MASK = 0x40, 
  INDIC2_MASK = 0x80, INDICS_MASK = 0xe0 
}
enum { 
...
enum { 
  ...
  SCLEX_OSCRIPT = 106, SCLEX_VISUALPROLOG = 107 
}
