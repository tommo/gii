...
private:
	...
	USLeanArray< float > mMap0;
	USLeanArray< float > mMap1; //double buffer
...
public:
	...
	inline USLeanArray< float > * getCurrentMap(){
		#if INFLUENCEMAP_USE_DOUBLE_BUFFER
			USLeanArray< float > * map = mCurrentMapId == 0 ? &mMap0 : &mMap1;
		#else
			USLeanArray< float > * map = &mMap0;
		#endif
		return map;
	}
...
private:
	...
	USLeanArray < TMInfluenceMapWalkerConfig > mConfigs;
...
public:
	...
	USIntVec2D  getVector  ( u32 x0, u32 y0 );
