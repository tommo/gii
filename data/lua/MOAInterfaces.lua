...
-- http://getmoai.com
--==============================================================
if MOAIApp then return end --interface loaded
...
MOAIRenderMgr.extend (
	...
	function ( class, superClass )
		...
		function class.affirmRenderTable ()
			...
			local renderTable = MOAIGfxDevice.getFrameBuffer():getRenderTable ()
		...
		function class.clearRenderStack ()
			MOAIGfxDevice.getFrameBuffer():setRenderTable ( nil )
		end
